...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sub = channel.stream_unary(
                '/calculator.Calculator/Sub',
                request_serializer=calculator__pb2.Number.SerializeToString,
                response_deserializer=calculator__pb2.Number.FromString,
                _registered_method=True)
        self.Mult = channel.stream_unary(
                '/calculator.Calculator/Mult',
                request_serializer=calculator__pb2.Number.SerializeToString,
                response_deserializer=calculator__pb2.Number.FromString,
                _registered_method=True)
        self.Div = channel.stream_unary(
...
class CalculatorServicer(object):
    ...
    def Mult(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def Div(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.stream_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=calculator__pb2.Number.FromString,
                    response_serializer=calculator__pb2.Number.SerializeToString,
            ),
            'Sub': grpc.stream_unary_rpc_method_handler(
                    servicer.Sub,
                    request_deserializer=calculator__pb2.Number.FromString,
                    response_serializer=calculator__pb2.Number.SerializeToString,
            ),
            'Mult': grpc.stream_unary_rpc_method_handler(
                    servicer.Mult,
                    request_deserializer=calculator__pb2.Number.FromString,
                    response_serializer=calculator__pb2.Number.SerializeToString,
            ),
            'Div': grpc.stream_unary_rpc_method_handler(
                    servicer.Div,
                    request_deserializer=calculator__pb2.Number.FromString,
                    response_serializer=calculator__pb2.Number.SerializeToString,
            ),
